...
const Partnerships: React.FC = () => {
  const partners = [
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" className="w-12 h-12 fill-none stroke-current">
          <path d="M4 20h16M7 14l3-3 4 4 5-5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-600" />
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" className="w-12 h-12 fill-none stroke-current">
          <rect x="3" y="3" width="7" height="7" rx="1" strokeWidth="1.5" className="text-emerald-600" />
          ...
          <rect x="14" y="14" width="7" height="7" rx="1" strokeWidth="1.5" className="text-emerald-600" />
