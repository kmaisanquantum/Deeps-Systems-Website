      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {articles.map((article, idx) => (
            <div 
              key={article.id} 
              className="bg-white dark:bg-[#0a0a0a] flex flex-col rounded-[2.5rem] overflow-hidden border border-gray-100 dark:border-white/5 hover:border-rose-500/20 transition-all duration-500 group reveal-on-scroll shadow-sm hover:shadow-xl"
            ...
            >
              <div className="h-48 bg-gray-50 dark:bg-slate-900/50 relative overflow-hidden flex items-center justify-center">
                ...
                <Zap className="w-12 h-12 text-rose-600 opacity-10 group-hover:opacity-30 transition-opacity" />
                <div className="absolute bottom-4 left-4">
                  <span className="px-3 py-1 rounded-full bg-white dark:bg-rose-500/10 text-rose-600 text-[10px] font-bold uppercase tracking-widest border border-gray-100 dark:border-rose-500/20 shadow-sm">
                    {article.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-8 flex-grow flex flex-col">
                ...
                <h3 className="text-xl font-bold mb-4 group-hover:text-rose-600 transition-colors leading-snug text-gray-900 dark:text-white">
                  {article.title}
                </h3>
                ...
                <div className="mt-auto flex items-center justify-between pt-6 border-t border-gray-50 dark:border-white/5">
                  <a href={article.url} className="flex items-center gap-2 text-sm font-bold text-gray-900 dark:text-white hover:text-rose-600 transition-all group/read active-click px-4 py-2 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 shadow-sm">
                    Read Article
                  ...
                  <button 
                    ...
                    className="p-2.5 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 text-gray-400 dark:text-slate-400 hover:text-rose-600 active-click transition-all group/share shadow-sm"
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/50 backdrop-blur-md animate-in fade-in duration-300">
          <div className="bg-white dark:bg-[#0a0a0a] w-full max-w-sm rounded-[2.5rem] p-8 border border-gray-100 dark:border-white/10 shadow-2xl relative animate-in zoom-in slide-in-from-bottom-4 duration-300">
            ...
            <button 
              ...
              className="w-full mt-6 py-4 rounded-xl bg-gray-900 dark:bg-rose-600 text-white text-sm font-bold transition-all active-click shadow-lg"
            >
              Copy Direct Link
            </button>
          </div>
