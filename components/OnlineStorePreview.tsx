...
const OnlineStorePreview: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-white dark:bg-[#0a0a0a] relative overflow-hidden">
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-rose-500/[0.02] dark:bg-rose-500/5 rounded-full blur-[120px] -z-10"></div>
        ...
        <div className="bg-gray-50 dark:bg-white/2 rounded-[3rem] border border-gray-100 dark:border-white/5 overflow-hidden shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8 md:p-16 flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-rose-50 dark:bg-rose-500/10 text-rose-600 text-[10px] font-bold uppercase tracking-widest mb-8 w-fit shadow-sm">
                <ShoppingBag className="w-3.5 h-3.5" />
                Now Open
              </div>

              <h2 className="text-4xl md:text-5xl font-montserrat font-bold mb-6 text-gray-900 dark:text-white leading-tight">
                The Deeps <span className="text-rose-600">Store</span>
              </h2>
              ...
              <a
                ...
                className="w-fit flex items-center gap-3 px-10 py-5 rounded-2xl quantum-gradient text-white font-bold text-lg btn-cta-pulse active-click shadow-xl shadow-rose-500/20"
              >
              ...
              <div className="relative z-10 w-full max-w-sm">
                <div className="bg-white dark:bg-[#0a0a0a] p-8 rounded-[2.5rem] border border-gray-200 dark:border-white/10 shadow-2xl space-y-6 transform rotate-3 hover:rotate-0 transition-transform duration-700">
                   <div className="flex justify-between items-start">
                      <div className="p-4 rounded-2xl bg-rose-50 dark:bg-rose-500/10 text-rose-600">
                   ...
                   <div className="pt-4 border-t border-gray-100 dark:border-white/5 flex items-center justify-between">
                      ...
                      <div className="px-4 py-2 rounded-xl bg-gray-50 dark:bg-white/5 text-[10px] font-bold text-rose-600 uppercase tracking-widest border border-gray-100 dark:border-white/10">
                        View Item
                      </div>
                   </div>
                </div>
                ...
                {/* Decorative Elements */}
                <div className="absolute -top-4 -right-4 w-24 h-24 bg-rose-500/10 rounded-full blur-2xl -z-10 animate-pulse"></div>
                <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-gray-200 dark:bg-white/5 rounded-full blur-3xl -z-10"></div>
              </div>
            </div>
