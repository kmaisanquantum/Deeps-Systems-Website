...
const OnlineStorePreview: React.FC = () => {
  ...
  return (
    <section id="online-store" className="py-24 bg-[#0a0a0a] relative overflow-hidden">
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-teal-500/5 rounded-full blur-[150px] -z-10"></div>
        ...
        <div className="glass rounded-[3rem] p-8 md:p-16 lg:p-24 border border-white/5 relative overflow-hidden group">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-teal-500/20 text-teal-400 text-[10px] font-bold uppercase tracking-widest mb-8">
                <ShoppingBag className="w-3.5 h-3.5" />
                Coming Soon
              </div>

              <h2 className="text-4xl md:text-6xl font-montserrat font-bold mb-8 leading-tight">
                Our <span className="text-teal-400">Online Store</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <button className="px-10 py-5 rounded-full quantum-gradient text-white font-bold text-lg shadow-xl shadow-teal-500/20 hover:scale-105 transition-transform active:scale-95">
                  Get Early Access
                </button>
            ...
            <div className="relative z-10 flex items-center justify-center">
              <div className="w-full max-w-md aspect-square glass rounded-[3rem] border border-white/10 flex items-center justify-center relative group/inner overflow-hidden shadow-2xl">
                 <div className="absolute inset-0 bg-teal-500/5 group-hover/inner:bg-teal-500/10 transition-colors"></div>
                 <div className="text-center p-12">
                    <div className="w-32 h-32 bg-teal-500/10 rounded-[2.5rem] flex items-center justify-center mx-auto mb-10 group-hover/inner:scale-110 group-hover/inner:rotate-12 transition-all duration-500">
                       <ShoppingBag className="w-14 h-14 text-teal-400" />
                    </div>
                 ...
                 {/* Decorative elements */}
                 <div className="absolute top-10 left-10 w-4 h-4 border border-teal-400/20 rounded-full"></div>
