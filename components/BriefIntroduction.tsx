  ...
  return (
    <section className="py-24 bg-white dark:bg-[#0a0a0a] border-y border-gray-100 dark:border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 text-center">
        <div className="inline-block px-4 py-1.5 rounded-full bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 text-[10px] font-bold text-emerald-600 uppercase tracking-widest mb-8 shadow-sm">
          The Deeps Mission
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {sectors.map((sector) => (
            <div key={sector.name} className="p-8 bg-white dark:bg-white/2 rounded-[2rem] border border-gray-100 dark:border-white/5 hover:border-emerald-500/20 transition-all hover:-translate-y-2 group shadow-sm hover:shadow-xl">
              <div className="mb-6 p-4 rounded-2xl bg-gray-50 dark:bg-emerald-500/10 inline-block group-hover:scale-110 transition-transform">
                {sector.icon}
              </div>
        ...
        >
          ...
          <ArrowRight className="w-5 h-5 group-hover:translate-x-2 transition-transform text-emerald-600" />
        </Link>
      </div>
    </section>
  );
