      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <div 
              key={i} 
              className="bg-white dark:bg-[#0a0a0a] p-8 rounded-3xl border border-gray-100 dark:border-white/5 transition-all duration-500 hover:border-emerald-500/20 hover:-translate-y-2 group flex flex-col justify-between shadow-sm hover:shadow-xl cursor-default"
            >
              <div>
                <div className="mb-6 p-3 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 inline-block group-hover:scale-110 transition-transform duration-300">
                  <Quote className="w-6 h-6 text-emerald-600 fill-emerald-600/20" />
                </div>
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full quantum-gradient flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-emerald-500/20">
                  {t.author.charAt(0)}
                </div>
                <div>
